...
/* XXX: original code was :             state->discard[player][i] = -1; */
            state->discard[player][ 0 * i] = -1;
        }
...
int adventurer_card(struct gameState *state, int drawntreasure, int currentPlayer, int cardDrawn, int temphand[MAX_HAND], int z) {
...
int feast_card(struct gameState *state, int currentPlayer, int temphand[MAX_HAND], int choice1) {
    int i, x;
...
int remodel_card(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2) {
    int i;
    int j = state->hand[currentPlayer][choice1];  //store card we will trash
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case adventurer:
            return adventurer_card(state, drawntreasure, currentPlayer, cardDrawn, temphand, z);
            
        case council_room:
            return council_room_card(currentPlayer, state, handPos);
            
        case feast:
            return feast_card(state, currentPlayer, temphand, choice1);
